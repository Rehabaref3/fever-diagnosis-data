...
# This figure helps identify which fever severity level is the most common in the selected dataset sample.
...
# This figure provides a clearer statistical comparison of heart rate variation, median values, and possible outliers across fever severity levels.
